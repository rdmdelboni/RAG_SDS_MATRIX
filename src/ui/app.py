...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_sds_tab(self) -> QtWidgets.QWidget:
        ...
        self.use_rag_checkbox.setStyleSheet(
            ...
            f"image: url(data:image/svg+xml,%3Csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20viewBox=%270%200%2024%2024%27%3E%3Cpath%20fill=%27white%27%20d=%27M9%2016.17L4.83%2012l-1.42%201.41L9%2019%2021%207l-1.41-1.41L9%2016.17z%27/%3E%3C/svg%3E);"
            f"}}"
