...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_sds_tab(self) -> QtWidgets.QWidget:
        ...
        self.use_rag_checkbox.setStyleSheet(
            ...
            f"background-color: {self.colors['primary']};"
            f"image: url(data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><path fill='%23a6adc8' d='M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z'/></svg>);"
            f"}}"
